...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string insertstr = "insert into  yonghu(username,psd,sex,phone,address,address1 ) values('" + txtusername.Text + "','" + txtpassword.Text + "','" + RadioButtonList1.SelectedItem.Text + "','" + txtdianhua.Text + "','" + txtdizhi.Text + "','" + address1 + "')";
        ...
        try
        {
            ...
            string selectstr = "select username,psd,sex,phone,address,assress1  from yonghu";
