<%@ Page Title="" Language="C#" MasterPageFile="~/xitong1.master" AutoEventWireup="true" CodeFile="bookgridviewedit.aspx.cs" Inherits="gridviewedit" Debug="true"%>
...
<style type="text/css">
    ...
    <link href="css/tbody.css" rel="stylesheet" type="text/css" />
    <div id="content">
     ...
     OnRowCancelingEdit="GridView1_RowCancelingEdit"
        ...
        <Columns>
            <asp:BoundField DataField="bookid" HeaderText="bookid" ReadOnly="True" 
                SortExpression="bokid" />
            <asp:BoundField DataField="title" HeaderText="title" SortExpression="title" ><controlstyle CssClass="height"/></asp:BoundField>
            <asp:BoundField DataField="author" HeaderText="author" SortExpression="author" ><controlstyle CssClass="height"/></asp:BoundField>
