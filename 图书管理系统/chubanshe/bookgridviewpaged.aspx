<%@ Page Title="" Language="C#" MasterPageFile="~/xitong1.master" AutoEventWireup="true" CodeFile="bookgridviewpaged.aspx.cs" Inherits="gridviewpaged" Debug="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style=" border:0px solid #ccc; width:700px; color:#333; font-size:14px;">
        <br />
    <span class="alert alert-success">请输入书籍号进行查询：</span><br />
        <br />
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging"
        ...
        CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="bookid" 
            >
               <AlternatingRowStyle  />
               <Columns>
