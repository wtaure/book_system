...
public partial class _Default : System.Web.UI.Page
{
    ...
    public void GridViewBind()
    {
        ...
        //定义SQL语句
        string SqlStr = "select * from news_messages";
        //实例化SqlDataAdapter对象
        SqlDataAdapter da = new SqlDataAdapter(SqlStr, myConn);
        //实例化数据集DataSet
        DataSet ds = new DataSet();
        da.Fill(ds, "news_messages");
        //绑定DataList控件
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string sqlStr = "update news_messages set title='" + stuName + "',editors='" + stuSex + "',classify='" + stringstuAge + "',neirong='" + studept + "' where  newsid='" + stuID + "'";
        SqlConnection myConn = GetCon();
        myConn.Open();
